...
state3:
  ...
  mov a, reflow_seconds
  clr c
  subb a, #45			;reflow time should be less than 45 seconds
  jc	Time_Not_over_Limit	;if reflow_seconds - 45 < 0
  Set_Cursor(2, 1)
  Send_Constant_String(#Too_Long)
  Wait_Milli_Seconds(#250)
  Wait_Milli_Seconds(#250)
  Wait_Milli_Seconds(#250)
  Wait_Milli_Seconds(#250)
  mov reflow_seconds, #0	;reset reflow seconds to 0s
...
state4:
  ...
  mov a, reflow_temp
  clr c
  subb a, #235			;reflow time should be less than 235 seconds
  jc	Temp_Not_over_Limit	;if reflow_seconds - 45 < 0
  Set_Cursor(2, 1)
  Send_Constant_String(#Too_High)
  Wait_Milli_Seconds(#250)
  Wait_Milli_Seconds(#250)
  Wait_Milli_Seconds(#250)
  Wait_Milli_Seconds(#250)
  mov reflow_temp, #0	;reset reflow seconds to 0s
